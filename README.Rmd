...
Looking deeper into the forecasted values, it can be seen that they belong to week 38 and 39, which correspond to the month of October, and where `fc$mean` corresponds to the forecast values' amplitudes.
```{r forecastedvaluesdeepdive, fig.width=10, echo=FALSE}
autoplot(fc$mean)
```
