...
```{r incrementinobservations, fig.width=8, echo=FALSE}
...
```{r timeframes, fig.width=8, echo=FALSE}
...
```{r breakdownalberdi, fig.width=8, echo=FALSE}
...
```{r breakdownretiro, fig.width=8, echo=FALSE}
...
```{r distributionofinfractions, fig.width=8, echo=FALSE}
...
Below are two charts with the distribution of infractions for both Alberdi and Retiro.
```{r infractionsalberdi, fig.width=8, echo=FALSE}
t <- custom.agg(df[(df$toll.booth == 'ALBERDI' & 
...
plot(p)
```
```{r infractionsretiro, fig.width=8, echo=FALSE}
t <- custom.agg(df[(df$toll.booth == 'RETIRO' & 
                      df$payment.method == 'INFRACCION'),],
                length(unique(df$Y)),
                'vehicle.type', 'start.hour')
...
```{r evolutionofinfractions, fig.width=8, echo=FALSE}
t <- df %>%
