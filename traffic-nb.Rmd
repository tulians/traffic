...
plot(volume.per.year$CANTIDAD_PASOS ~ volume.per.year$PERIODO, xlab = 'Years', ylab = 'Amount of vehicles')
```

For the graph above it's clear there's an order of magnitud of difference between the amount of vehicles in the period 2008-2013 versus the period 2014-2018. This difference is due to the fact that new toll booth locations were added to the dataset along the years, which ended up adding 10x more information.
