...
rm(automatic_payments, avellaneda_ff, payment_methods_lambdas, payments,
   payments_per_hour, amount_of_days, automatic_tolls, lambda, mu,
   mu_automatic, mu_manual, years_to_filter_by)
n <- 1:S
rho <- 0.9
