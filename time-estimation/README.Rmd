...
packages.to.include <- c('dplyr', 'tibble', 'ggplot2', 'ff')
...
ggplot(data = ff.df, aes(x = price, y = vehicles)) +
  ...
  labs(x = 'Oil price (ARS)', 
       ...
       title = 'Relation with oil price and amount of vehicles', 
       caption = 'Figure 2') +
  theme_minimal()
